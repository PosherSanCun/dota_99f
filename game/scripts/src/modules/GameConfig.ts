export class GameConfig {
    constructor() {
        ...
        game.SetCustomGameForceHero(`npc_dota_hero_undying`); // 设置强制英雄（会直接跳过英雄选择阶段并直接为所有玩家选择这个英雄）
        //game.SetCustomGameForceHero(`npc_dota_hero_monkey_king`); // 设置强制英雄（会直接跳过英雄选择阶段并直接为所有玩家选择这个英雄）
